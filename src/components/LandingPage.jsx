...
export default function LandingPage({ proposals, siteContent, onSelectProposalForPdf }) {
  ...
  const handleGenerateCustomPdf = (e) => {
    ...
    const customProposalForPdf = {
      ...
      eventDate: "A definir",
      eventType:
        proposalModalType === "completa"
          ? "Assessoria e Cerimonial Completo"
          : "Cerimonial",
      ...
      pricingByGuests: {
        ...
        guestCount: selectedTier?.range || "",
        finalPrice: selectedTier
          ? selectedTier.price || "Sob consulta"
          : baseProposal.price,
  ...
  const carouselImages = siteContent.gallery.map((image) => ({
    ...image,
    url: photoSources[image.photo] || eventPhoto01,
  }));
    ...
    <div style={{ minHeight: "100vh", background: "var(--bg-page)" }}>
      ...
      <header className="header-nav">
        <a href="#" className="brand-logo-container" title={siteContent.brandName}>
          <img
            src={brandLogo}
            alt={`Logo ${siteContent.brandName}`}
      ...
      <section className="hero-section">
        ...
        <h1 className="hero-title">
          {siteContent.heroLead}{" "}
          <span className="gold-accent">{siteContent.heroAccent}</span>
        </h1>
      ...
      <section className="section-container" style={{ marginTop: "50px" }}>
        <div className="section-header">
          ...
          <h2 className="section-title">
            {siteContent.galleryLead}{" "}
            <span className="navy-accent">{siteContent.galleryAccent}</span>
          </h2>
        </div>
      ...
      <section className="section-container">
        <div className="section-header">
          ...
          <h2 className="section-title">
            {siteContent.packagesLead}{" "}
            <span className="navy-accent">{siteContent.packagesAccent}</span>
          </h2>
        </div>
            ...
            <div className="package-card featured">
              ...
              <div>
                ...
                <ul className="package-checklist">
                  {proposals.completa.items &&
                    proposals.completa.items.map((item, i) => (
                      <li key={i}>
          ...
          {proposals.cerimonial && (
            <div className="package-card">
              <div>
                ...
                <ul className="package-checklist">
                  {proposals.cerimonial.items &&
                    proposals.cerimonial.items.map((item, i) => (
                      <li key={i}>
                        <CheckCircle2 size={16} /> {item}
                      </li>
                    ))}
        ...
        <div className="modal-overlay" onClick={() => setProposalModalType(null)}>
          ...
          >
            <button
              ...
              onClick={() => setProposalModalType(null)}
            >
              <X size={18} />
            </button>
            ...
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              ...
              >
                Informe seus dados para receber o documento completo personalizado com seu
                nome e CPF.
              </p>
            </div>
            ...
            <form onSubmit={handleGenerateCustomPdf}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setClientData((prev) => ({ ...prev, cpf: maskCPF(e.target.value) }))
                  }
                  required
                />
              </div>

              {(proposals[proposalModalType]?.pricingByGuests?.tiers || []).length >
                0 && (
                <div>
                  <label
                    htmlFor="proposal-guest-tier"
                    style={{
                      fontSize: "11.5px",
                      fontWeight: "bold",
                      color: "var(--secondary-navy)",
                  ...
                  >
                    Opções de convidados *
                  </label>
                  <select
                    id="proposal-guest-tier"
                    value={clientData.guestTierId}
                    onChange={(e) =>
                      setClientData((prev) => ({ ...prev, guestTierId: e.target.value }))
                    }
                    required
                  >
        ...
        <div className="modal-overlay" onClick={() => setModalOpen(false)}>
          <div className="modal-content-clean" onClick={(e) => e.stopPropagation()}>
            ...
            <div style={{ textAlign: "center", marginBottom: "20px" }}>
              <h2
                className="serif-title"
                style={{ fontSize: "24px", color: "var(--secondary-navy)" }}
              >
      ...
      <footer className="footer-clean">
        <p style={{ marginBottom: "4px" }}>
          {siteContent.brandName} &copy; {new Date().getFullYear()} .{" "}
